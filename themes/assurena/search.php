        ...
        <?php
            ...
            ?>
                <header class="searсh-header">
                    <h1 class="page-title"><?php printf( esc_html__( 'Search Results for: %s', 'assurena' ), '<span>' .get_search_query(). '</span>' ); ?></h1>
                </header>
                <?php
                ...
                $stl_blog_atts = array(
                    ...
                    'read_more_text' => esc_html__( 'Learn More', 'assurena' ),
                ...
                <div class="page_404_wrapper">
                    <header class="searсh-header">
                        <h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'assurena' ); ?></h1>
                    </header>

                    <div class="page-content">
                        <?php if ( is_search() ) : ?>
                            <p class="banner_404_text"><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'assurena' ); ?></p>
                        <?php else : ?>
                            <p class="banner_404_text"><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'assurena' ); ?></p>
                        <?php endif; ?>
                        <div class="search_result_form">
                            <?php get_search_form(); ?>
                        </div>
                        <div class="assurena_404__button">
                            <a class="assurena_404__link stl-button" href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e( 'Take Me Home', 'assurena' ); ?></a>
                        </div>
                    </div>
