...
( function( $ ) {
	...
	$(document).ready(function (){
		window.stl_metabox_addon 	= new stl_metabox_addon({});
	});

	function stl_metabox_addon(){
		var that = this;

		that.set_tabs = stl_metabox_tab;
		that.set_dependancy = stl_metaboxio_dependancy;
	...
	*/	
	...
	function stl_metaboxio_dependancy ($a){
