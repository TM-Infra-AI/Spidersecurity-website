...
/**
* assurena Theme Autoload
*
*
* @class        assurena_Theme_Autoload
* @version      1.0
* @category     Class
* @author       StylusThemes
*/

if (!class_exists('assurena_Theme_Autoload')) {
	class assurena_Theme_Autoload{
		...
		public function tgm_register(){
			 require_once( get_theme_file_path('/core/tgm/stl-tgm.php') );
		} 
	}
	new assurena_Theme_Autoload();
