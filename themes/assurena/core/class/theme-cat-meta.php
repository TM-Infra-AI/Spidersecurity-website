...
*
*
* @class        stl_Cat_Images
* @version      1.0
* @category     Class
* @author       StylusThemes
*/
if ( ! class_exists( 'stl_Cat_Images' ) ) {
...
function category_fields( $term ) {    //check for existing featured ID
	...
	?>
		<tr class="form-field term-colorpicker-wrap">
				<th scope="row"><label for="term-colorpicker"><?php echo esc_html__( 'Color', 'assurena' );?></label></th>
				<td>
...
public function load_media() {
	wp_enqueue_script('assurena-cat-meta', get_template_directory_uri() . '/core/admin/js/cat_img_upload.js', array(), false, false);
	wp_enqueue_media();
 ...
 */ 
 public function add_category_image ( $taxonomy ) {
		...
		<div class="form-field term-colorpicker-wrap">
				<label for="term-colorpicker"><?php echo esc_html__( 'Color', 'assurena' );?></label>
				<input name="_category_color" value="<?php echo esc_attr($theme_color);?>" class="colorpicker" id="term-colorpicker" />
		</div>
	 <div class="form-field term-group stl-image-form">
		 <label for="category-image-id"><?php esc_html_e('Background Image', 'assurena'); ?></label>
		 <input type="hidden" id="category-image-id" name="category-image-id" class="custom_media_url" value="">
		 <div class="category-image-wrapper"></div>
		 <p>
			 <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button" name="ct_tax_media_button" value="<?php esc_attr_e( 'Add Image', 'assurena' ); ?>" />
			 <input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove" name="ct_tax_media_remove" value="<?php esc_attr_e( 'Remove Image', 'assurena' ); ?>" />
		</p>
	 </div>
	 <div class="form-field term-group stl-image-form">
		 <label for="category-icon-image-id"><?php esc_html_e('Icon Image', 'assurena'); ?></label>
		 <input type="hidden" id="category-icon-image-id" name="category-icon-image-id" class="custom_media_url" value="">
		 <div class="category-image-wrapper"></div>
		 <p>
			 <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button_icon" name="ct_tax_media_button" value="<?php esc_attr_e( 'Add Image', 'assurena' ); ?>" />
			 <input type="button" class="button button-secondary ct_tax_media_remove" id="ct_tax_media_remove_icon" name="ct_tax_media_remove" value="<?php esc_attr_e( 'Remove Image', 'assurena' ); ?>" />
		</p>
	 </div>
 <?php
 }
 ...
 */
 public function update_category_image ( $term, $taxonomy ) { ?>
	 <tr class="form-field term-group-wrap stl-image-form">
		 <th scope="row">
			 <label for="category-image-id"><?php esc_html_e( 'Background Image', 'assurena' ); ?></label>
		 </th>
		 <td>
...
$stl_Cat_Images = new stl_Cat_Images();
$stl_Cat_Images -> init();
