...
if (! class_exists('assurena_header_side_area')) {
	class assurena_header_side_area extends assurena_get_header
	{
		public function __construct()
		{
			$this->header_vars();

			$side_panel_enable = assurena_Theme_Helper::get_option('side_panel_enable');
		...
		{
			$page_select = assurena_Theme_Helper::options_compare('side_panel_page_select','mb_customize_side_panel','custom');
