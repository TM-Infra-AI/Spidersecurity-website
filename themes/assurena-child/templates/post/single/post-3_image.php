...
$single_date =  assurena_Theme_Helper::get_option('single_meta_date');
$featured_image = assurena_Theme_Helper::options_compare('post_hide_featured_image', 'mb_post_hide_featured_image', '1');
...
$page_title_padding = assurena_Theme_Helper::options_compare('single_padding_layout_3', 'mb_post_layout_conditional', 'custom');
...
$apply_animation = assurena_Theme_Helper::options_compare('single_apply_animation', 'mb_post_layout_conditional', 'custom');
	  ...
	  <div class="blog-post_content"><?php
		...
		echo '<div class="stl-container">';
		  echo '<div class="row">';
			...
			echo '<div class="content-container stl_col-12"', $data_attr_content, '>'; 
