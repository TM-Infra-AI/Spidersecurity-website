...
class Header
{
    ...
    {
        $this->name = __('Header Templates', 'assurena-core');
        $this->slug = 'header';
        $this->plural_name = __('Header Templates', 'assurena-core');
    ...
    public function register()
    {
        $labels = [
            ...
            'add_new' => sprintf(__('Add New Template', 'assurena-core'), $this->name),
            ...
            'all_items' => sprintf(__('All Templates', 'assurena-core'), $this->plural_name),
    ...
    public function wrapper_header_open()
    {
        ...
        if ($post->post_type == $this->type) {
            echo '<header class="stl-theme-header">';
                echo '<div class="stl-site-header">';
