...
use stlAddons\Templates\stlBlog;
...
class stl_Blog extends Widget_Base
{
	...
	public function get_title() {
		return esc_html__('stl Blog', 'assurena-core');
	}
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			'blog_subtitle',
			[
				'label' => esc_html__('Subitle', 'assurena-core'),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'blog_columns',
			[
				'label' => esc_html__('Grid Columns Amount', 'assurena-core'),
				'type' => Controls_Manager::SELECT,
				'label_block' => true,
				'options' => [
					'12' => esc_html__('One', 'assurena-core'),
					'6' => esc_html__('Two', 'assurena-core'),
					'4' => esc_html__('Three', 'assurena-core'),
					'3' =>esc_html__('Four', 'assurena-core') 
				],
				'default' => '12',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Navigation\'s Alignment', 'assurena-core'),
				'type' => Controls_Manager::SELECT,
		...
		$this->add_control(
			'spacer_navigation',
			[
				'label' => esc_html__('Navigation Margin Top', 'assurena-core'),
				...
				'selectors' => [
					'{{WRAPPER}} .stl-pagination' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'spacer_load_more',
			[
				'label' => esc_html__('Button Spacer Top', 'assurena-core'),
				'type' => Controls_Manager::SLIDER,
				'condition' => [
					'blog_navigation' => 'load_more',
					'blog_layout' => [ 'grid', 'masonry' ]
		...
		$this->add_control(
			'hide_media',
			[
				'label' => esc_html__('Hide Media?', 'assurena-core'),
		...
		$this->add_control(
			'hide_blog_title',
			[
				'label' => esc_html__('Hide Title?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'hide_content',
			[
				'label' => esc_html__('Hide Content?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'hide_postmeta',
			[
				'label' => esc_html__('Hide all post-meta?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'meta_author',
			[
				'label' => esc_html__('Hide post-meta author?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'meta_comments',
			[
				'label' => esc_html__('Hide post-meta comments?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [ 'hide_postmeta!' => 'yes' ],
				'default' => 'yes'
			]
		...
		$this->add_control(
			'meta_categories',
			[
				'label' => esc_html__('Hide post-meta categories?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [ 'hide_postmeta!' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'meta_date',
			[
				'label' => esc_html__('Hide post-meta date?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [ 'hide_postmeta!' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'hide_share',
			[
				'label' => esc_html__('Hide Post Share?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'read_more_hide',
			[
				'label' => esc_html__('Hide \'Read More\' button?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'read_more_text',
			[
				'label' => esc_html__('Read More Text', 'assurena-core'),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Characters Amount in Content', 'assurena-core'),
		...
		$this->add_control(
			'crop_square_img',
			[
				'label' => esc_html__('Crop Images for Posts List?', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control( 
			'use_pagination',
			[
				'label' => esc_html__('Add Pagination controls', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'custom_pag_color',
			[
				'label' => esc_html__('Customize Color', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'condition' => [ 'use_pagination' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'use_navigation',
			[
				'label' => esc_html__('Add Navigation controls', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'default' => 'yes',
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Module Title', 'assurena-core'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Meta Info', 'assurena-core'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'custom_blog_mask',
			[
				'label' => esc_html__('Add Image Idle Overlay', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('On', 'assurena-core'),
				'label_off' => esc_html__('Off', 'assurena-core'),
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Add Image Hover Overlay', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('On', 'assurena-core'),
				'label_off' => esc_html__('Off', 'assurena-core'),
			]
		...
		$this->add_control(
			'custom_blog_bg_item',
			[
				'label' => esc_html__('Add Items Background', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__('On', 'assurena-core'),
				'label_off' => esc_html__('Off', 'assurena-core'),
			]
