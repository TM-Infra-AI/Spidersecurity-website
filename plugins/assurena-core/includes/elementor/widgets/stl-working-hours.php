...
class stl_Working_Hours extends Widget_Base {
    
    public function get_name() {
        return 'stl-working-hours';
    }

    public function get_title() {
        return esc_html__('stl Working Hours', 'assurena-core');
    }
    ...
    protected function _register_controls() {
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'default' => esc_html__('Monday', 'assurena-core'),
            )
        );
        ...
        $repeater->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('8.00 - 21.00', 'assurena-core'),
            )
        );
        ...
        $repeater->add_control(
            'custom_colors',
            array(
                'label' => esc_html__('Custom Colors', 'assurena-core'),
        ...
        $repeater->add_control(
            'day_color',
            array(
                'label' => esc_html__('Day Color', 'assurena-core'),
        ...
        $repeater->add_control(
            'hours_color',
            array(
                'label' => esc_html__('Hours Color', 'assurena-core'),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'items',
            array(
                'label' => esc_html__('Days', 'assurena-core'),
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    [ 'working_day' => esc_html__('Monday', 'assurena-core')],
                    [ 'working_day' => esc_html__('Tuesday', 'assurena-core')],
                ],
        ...
        $this->start_controls_section(
            'style_section',
            array(
                'label' => esc_html__('Styles', 'assurena-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Item Styles', 'assurena-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Day Styles', 'assurena-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Hours Styles', 'assurena-core'),
            ]
        );
        ...
        $this->add_control(
            'line_color',
            array(
                'label' => esc_html__('Line Between Color', 'assurena-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '#e5e5e5',
                'selectors' => array(
