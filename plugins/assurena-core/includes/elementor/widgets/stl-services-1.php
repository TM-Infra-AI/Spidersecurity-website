...
class stl_Services_1 extends Widget_Base {
    
    public function get_name() {
        return 'stl-services-1';
    }

    public function get_title() {
        return esc_html__('stl Services 1', 'assurena-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .stl-services-1_title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .stl-services-1_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .stl-services-1 .stl-services-1_title_wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}}:hover .stl-services-1_title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}}:hover .stl-services-1 .stl-services-1_title_wrap' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .stl-services-1 .stl-services-1_image-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    '{{WRAPPER}} .stl-services-1 .stl-services-1_title_wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
    ...
    public function render()
    {
        ...
        <div <?php echo $this->get_render_attribute_string( 'services' ); ?>>
            <div class="stl-services_wrap acenter"><?php
                if (!empty($settings[ 'service_image' ])) {?>
                    <div class="stl-services-1_image-wrap"><img <?php echo $this->get_render_attribute_string( 'image' ); ?> /></div><?php
                    } ?>
                <div class="stl-services-1_title_wrap">
                    <?php if ((bool)$settings[ 'add_read_more' ]) {?><a class="stl-services-1_link" href="#" target="_self" rel=""><?php } ?>
                        <<?php echo $settings[ 'title_tag' ]; ?> class="stl-services-1_title"><?php echo $settings[ 'services_title' ];?></<?php echo $settings[ 'title_tag' ]; ?>>
                    <?php if ((bool)$settings[ 'add_read_more' ]) {?></a><?php } ?>
                </div>
                <?php    
