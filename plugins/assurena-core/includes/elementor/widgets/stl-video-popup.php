...
class stl_Video_Popup extends Widget_Base {

	public function get_name() {
		return 'stl-video-popup';
	}

	public function get_title() {
		return esc_html__('stl Video Popup', 'assurena-core');
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'stl_video_popup_section',
			[
				'label' => esc_html__('Video Popup Settings', 'assurena-core'),
			]
		);
		...
		$this->add_control(
			'subtitle',
			[
				'label' => esc_html__('Subtitle', 'assurena-core'),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__('Play', 'assurena-core'),
			]
		);
		...
		$this->add_control(
			'link',
			[
				'label' => esc_html__('Video Link', 'assurena-core'),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__('Enter your URL', 'assurena-core'),
				'description' => esc_html__('Enter video link from youtube or vimeo.', 'assurena-core'),
		...
		$this->add_control(
			'title_pos',
			[
				'label' => esc_html__('Title Position', 'assurena-core'),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'inline' => [
						'title' => esc_html__('Inline', 'assurena-core'),
		...
		$this->add_control(
			'bg_image',
			[
				'label' => esc_html__('Background Image', 'assurena-core'),
				'type' => Controls_Manager::MEDIA,
				'label_block' => true,
				'description' => esc_html__('Select video background image.', 'assurena-core'),
				'separator' => 'after',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => esc_html__('No animation', 'assurena-core'),
					'ring_static' => esc_html__('Static Ring', 'assurena-core'),
					'ring_pulse' => esc_html__('Pulsing Ring', 'assurena-core'),
					'ring_rotate' => esc_html__('Rotating Ring', 'assurena-core'),
					'circles' => esc_html__('Divergent Rings', 'assurena-core'),
				],
				'default' => '',
			]
		);
		...
		$this->add_control(
			'anim_color',
			[
				'label' => esc_html__('Animation Element Color', 'assurena-core'),
		...
		$this->add_control(
			'subtitle_tag',
			[
				'label' => esc_html__('Subtitle Tag', 'assurena-core'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => '‹h1›',
					'h2' => '‹h2›',
		...
		$this->add_control(
			'button_size',
			[
				'label' => esc_html__('Button Size', 'assurena-core'),
				...
				'description' => esc_html__('Button diameter in pixels.', 'assurena-core'),
				'selectors' => [
        ...
        $this->start_controls_tab(
            ...
            [ 'label' => esc_html__('Normal' , 'assurena-core') ]
        );
        ...
        $this->add_group_control(
			...
			[
				'name' => 'bg_color',
				'label' => esc_html__('Button Background', 'assurena-core'),
		...
		$this->add_control(
			'triangle_size',
			[
				'label' => esc_html__('Triangle Size', 'assurena-core'),
				'type' => Controls_Manager::SLIDER,
				'separator' => 'before',
				'range' => [
					'px' => ['max' => 100],
		...
		$this->add_control(
			'triangle_color',
			[
				'label' => esc_html__('Triangle Color', 'assurena-core'),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
		...
		$this->add_control(
			'triangle_corners',
			[
				'label' => esc_html__('Triangle Rounded Corners', 'assurena-core'),
				'type' => Controls_Manager::SWITCHER,
				'separator' => 'after',
				'label_on' => esc_html__('On', 'assurena-core'),
				'label_off' => esc_html__('Off', 'assurena-core'),
	...
	protected function render()
	{
		...
		switch ($_s[ 'animation_style' ]) {
			...
			case 'ring_static':
				...
				break;
			case 'ring_rotate':
				$svg_ring_circle_color = !empty($_s[ 'anim_color' ]) ? 'rgba('.\assurena_Theme_Helper::HexToRGB($_s[ 'anim_color' ]).', 0.1)' : 'rgba(0,0,0,0.1)';
