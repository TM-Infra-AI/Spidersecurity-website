...
use stlAddons\Templates\stlProgressBar;
...
class stl_Progress_Bar extends Widget_Base {
    
    public function get_name() {
        return 'stl-progress-bar';
    }

    public function get_title() {
        return esc_html__('stl Progress Bar', 'assurena-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('stl_progress_bar_section',
            array(
                'label' => esc_html__('Progress Bar Settings', 'assurena-core'),
            )
        );
        ...
        $this->add_control('progress_title',
            array(
				...
				'default' => esc_html__('My Skill', 'assurena-core'),
				'label_block' => true,
            )
        );
        ...
        $this->add_control('units',
            array(
                'label' => esc_html__('Units', 'assurena-core'),
                'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__('Enter your units', 'assurena-core'),
				'description' => esc_html__('Enter measurement units (Example: %, px, points, etc.)', 'assurena-core'),
				'default' => esc_html__('%', 'assurena-core'),
				'label_block' => true,
            )
        );
        ...
        $this->add_control(
			'value_pos',
			[
				'label' => esc_html__('Value Position', 'assurena-core'),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fixed' => esc_html__('Fixed', 'assurena-core'),
					'dynamic' => esc_html__('Dynamic', 'assurena-core'),
				],
				'default' => 'fixed',
			]
        );
        ...
        $this->start_controls_section(
            'bar_style_section',
            array(
                'label' => esc_html__('Progress Bar', 'assurena-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            )
        );
		...
		$this->add_control(
			'bar_height',
			[
				'label' => esc_html__('Progress Bar Height', 'assurena-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 1,
        ...
        $this->add_control(
            'bar_bg_color',
            array(
                'label' => esc_html__('Empty Bar Color', 'assurena-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => array(
        ...
        $this->add_control(
            'bar_color',
            array(
                'label' => esc_html__('Filled Bar Color', 'assurena-core'),
                'type' => Controls_Manager::COLOR,
