...
class stl_Header_Date extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('stl Current Date', 'assurena-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Date Settings', 'assurena-core'),
            ]
        );
        ...
        $this->add_control(
            'date_format_select',
            [
                'label' => esc_html__('Date Format', 'assurena-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'default' => esc_html__('Default', 'assurena-core'),
                    'wordpress_format' => esc_html__('Wordpress Format', 'assurena-core'),
        ...
        $this->add_control(
            'date_format_custom',
            [
                'label' => esc_html__('Custom Date Format', 'assurena-core'),
                ...
                'description' => __( 'Set your date format, about this, please refer to the ', 'assurena-core') . sprintf( ' <a href="%1$s" target="_blank">%2$s</a>', 'https://wordpress.org/support/article/formatting-date-and-time/', __( 'Wordpress.org', 'assurena-core') ),
            ]
        );         
        ...
        $this->add_control(
            'time_zone',
            [
                'label' => esc_html__('Time Zone', 'assurena-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'UTC' => esc_html__('Default', 'assurena-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'toggle' => true,
                'selectors' => [
                    '{{WRAPPER}} .stl-header-date' => 'justify-content: {{VALUE}};',
                ],
            ]
        );  
        ...
        $this->add_control(
            'date_color',
            [ 
                'label' => esc_html__('Text Idle', 'assurena-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .stl-header-date' => 'color: {{VALUE}}',
                ],
            ]
        );      
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .stl-header-date',
            ]
        );
    ...
    public function render(){
        ...
        echo '<div class="stl-header-date'.esc_attr($class_date).'">';
            echo \assurena_Theme_Helper::render_html( $date->format( $date_format ) );
        echo '</div>';
    }
