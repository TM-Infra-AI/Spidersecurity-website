...
class stl_Header_Delimiter extends Widget_Base {
    
    public function get_name() {
        return 'stl-header-delimiter';
    }

    public function get_title() {
        return esc_html__('stl Delimiter', 'assurena-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Delimiter Settings', 'assurena-core' ),
            ]
        );
        ...
        $this->add_control(
            'delimiter_height',
            array(
                'label' => esc_html__( 'Delimiter Height', 'assurena-core' ),
        ...
        $this->add_control(
            'delimiter_width',
            array(
                'label' => esc_html__( 'Delimiter Width', 'assurena-core' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'step' => 1,
                'default' => 1,
