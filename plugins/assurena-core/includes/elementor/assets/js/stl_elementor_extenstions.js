(function( $ ) {
	...
	/* Radio Image Select */
	jQuery( document ).on('click', '.stl-radio-image label', function(e){   
	...
	jQuery( window ).on( 'elementor:init', function() {
		...
		var stlControlIconView = elementor.modules.controls.Select2.extend( {

			initialize: function initialize() {
				stlControlSelect2View.prototype.initialize.apply(this, arguments);
				this.filterIcons();
			},
		...
		elementor.addControlView( 'stl-icon', stlControlIconView );
	
		var stlControlSelect2View = elementor.modules.controls.Select2;

		stlControlSelect2View.extend({
			_enqueuedFonts: [],
